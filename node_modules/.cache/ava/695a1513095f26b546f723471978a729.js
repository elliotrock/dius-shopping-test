...
var _pricingRules = require('../src/pricing-rules.js');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _ava2.default)('test pricingRules 3x ipd', function (t) {
  var testBasket = [{ sku: 'ipd', name: 'Super iPad', price: 549.99 }, { sku: 'ipd', name: 'Super iPad', price: 549.99 }, { sku: 'ipd', name: 'Super iPad', price: 549.99 }];
  return (0, _pricingRules.pricingRules)(testBasket).then(function (result) {
    var _rec = new _powerAssertRecorder();

    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === _rec._capt(549.99 * 3, 'arguments/0/right'), 'arguments/0'), {
      content: 't.true(result === 549.99 * 3)',
      filepath: 'tests/pricing-rules.test.js',
      line: 12,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"BinaryExpression","operator":"*","left":{"type":"NumericLiteral","value":549.99,"range":[18,24]},"right":{"type":"NumericLiteral","value":3,"range":[27,28]},"range":[18,28]},"range":[7,28]}],"range":[0,29]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":549.99,"range":[18,24]},{"type":{"label":"*"},"value":"*","range":[25,26]},{"type":{"label":"num"},"value":3,"range":[27,28]},{"type":{"label":")"},"range":[28,29]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
(0, _ava2.default)('test pricingRules 1x atv', function (t) {
  var testBasket = [{ sku: 'atv', name: 'Apple TV', price: 109.50 }];
  return (0, _pricingRules.pricingRules)(testBasket).then(function (result) {
    var _rec2 = new _powerAssertRecorder();

    t.log(result);
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(result, 'arguments/0/left') === 109.50, 'arguments/0'), {
      content: 't.true(result === 109.50)',
      filepath: 'tests/pricing-rules.test.js',
      line: 21,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"NumericLiteral","value":109.5,"range":[18,24]},"range":[7,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":109.5,"range":[18,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/695a1513095f26b546f723471978a729.js.map