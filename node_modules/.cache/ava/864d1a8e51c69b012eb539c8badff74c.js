...
var _checkout = require('../src/checkout');
...
(0, _ava2.default)('accept checkout no deals ', function (t) {
  var catalogue = [{ sku: 'ipd', name: 'Super iPad', price: 549.99 }, { sku: 'mbp', name: 'MacBook Pro', price: 1399.99 }, { sku: 'atv', name: 'Apple TV', price: 109.50 }, { sku: 'vga', name: 'VGA adapter', price: 30.00 }];
  var item = 'atv';
  var checkout = new _checkout2.default(catalogue);
  checkout.scan(item);
  return checkout.total().then(function (result) {
    var _rec = new _powerAssertRecorder();

    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === 109.50, 'arguments/0'), {
      content: 't.true(result === 109.50)',
      filepath: 'tests/checkout.test.js',
      line: 43,
...
(0, _ava2.default)('accept checkout deal ', function (t) {
  var catalogue = [{ sku: 'ipd', name: 'Super iPad', price: 549.99 }, { sku: 'mbp', name: 'MacBook Pro', price: 1399.99 }, { sku: 'atv', name: 'Apple TV', price: 109.50 }, { sku: 'vga', name: 'VGA adapter', price: 30.00 }];
  var checkout = new _checkout2.default(catalogue);
  ...
  return checkout.total().then(function (result) {
    ...
    t.log(result);
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(result, 'arguments/0/left') === 2718.95, 'arguments/0'), {
      content: 't.true(result === 2718.95)',
      filepath: 'tests/checkout.test.js',
      line: 64,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"NumericLiteral","value":2718.95,"range":[18,25]},"range":[7,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":2718.95,"range":[18,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/864d1a8e51c69b012eb539c8badff74c.js.map