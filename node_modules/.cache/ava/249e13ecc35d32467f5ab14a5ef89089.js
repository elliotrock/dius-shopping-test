...
(0, _ava2.default)('test checkout false scan', function (t) {
  t.is(scan('abc'), false);
});
...
(0, _ava2.default)('accept checkout deal ', function (t) {
  ...
  return checkout.total().then(function (result) {
    ...
    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === 2718.95, 'arguments/0'), {
...
//# sourceMappingURL=../node_modules/.cache/ava/249e13ecc35d32467f5ab14a5ef89089.js.map