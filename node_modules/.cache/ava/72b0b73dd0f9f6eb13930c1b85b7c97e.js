...
(0, _ava2.default)('accept checkout deal ', function (t) {
  ...
  return checkout.total().then(function (result) {
    ...
    t.log(result);
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(result, 'arguments/0/left') === 249.00, 'arguments/0'), {
      content: 't.true(result === 249.00)',
      filepath: 'tests/checkout.test.js',
      line: 60,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"NumericLiteral","value":249,"range":[18,24]},"range":[7,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":249,"range":[18,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/72b0b73dd0f9f6eb13930c1b85b7c97e.js.map